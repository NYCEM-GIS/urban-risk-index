...
df_hosp_2016 = pd.read_csv(path_hosp_2016, skiprows=6, skipfooter=17, engine='python')
df_emerg = pd.read_csv(path_emerg, skiprows=12, skipfooter=5, engine='python')
df_emerg_2016 = pd.read_csv(path_emerg_2016, skiprows=6, skipfooter=17, engine='python')
