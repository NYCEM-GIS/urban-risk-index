...
add_params(
    ...
    value = 257,
    source = "FY 2024 Per Diem Rates for New York | GSA",
    source_year = 2016,
...
add_params(
    ...
    value = 1.5,
    source = "Plan for Hazards - Hazard Mitigation - NYCEM",
    source_year = 2019,
...
add_params(
    ...
    value = 588000,
    source = "Benefit-Cost Analysis Sustainment and Enhancements: Standard Economic Values Methodology Report (Version 12.0) (fema.gov)",
    source_year = 2016,
    description = "FEMA Benefit-Cost (FEMA 2016)",
    unit = "USD",
    type = "PARAMS",
)
...
add_params(
    ...
    value = 8955,
    source = "FEMA Ecosystem Service Value Updates",
    source_year = 2022,
