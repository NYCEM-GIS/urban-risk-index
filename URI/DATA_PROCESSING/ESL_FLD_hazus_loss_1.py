...
gdf_flood_Bronx = gpd.read_file(r".\1_RAW_INPUTS\Hazus - Loss Estimation Data\Coastal Flooding\Coastal Flooding 100 Year\Bronx\Bronx_100PFIRM\results.shp")
gdf_flood_Kings = gpd.read_file(r".\1_RAW_INPUTS\Hazus - Loss Estimation Data\Coastal Flooding\Coastal Flooding 100 Year\Kings\Kings_100PFIRM\results.shp")
gdf_flood_New_York= gpd.read_file(r".\1_RAW_INPUTS\Hazus - Loss Estimation Data\Coastal Flooding\Coastal Flooding 100 Year\New York\NewYork_100PFIRM\results.shp")
...
gdf_flood_data_list = [gdf_flood_Bronx,gdf_flood_Kings,gdf_flood_New_York,gdf_flood_Queens,gdf_flood_Richmond]
gdf_flood_databytract_list = []
for fld_file in gdf_flood_data_list:
    fld_file['tract'] = fld_file['block'][:11]
    fld_file_bytract = fld_file[['tract','EconLoss','geometry']].dissolve(by='tract', as_index=False)
    gdf_flood_databytract_list.append(fld_file_bytract)

gdf_flood_databytract_list.append(fld_file_bytract)
gdf_flood = gpd.GeoDataFrame(pd.concat(gdf_flood_databytract_list,ignore_index=True))
