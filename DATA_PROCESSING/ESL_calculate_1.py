...
for i, haz in enumerate(list_abbrev_haz):
    ...
    for idx in df_cons.index:
        ...
        #ESL.add_consequence(this_name, this_receptor.replace(" ", "_"), gdf_consequence)
        # plot
        #plotting.plot_ESL_nb(haz, ESL.consequence[this_name]["map_tract"],
        #                     'Loss USD - {}'.format(this_factor))
